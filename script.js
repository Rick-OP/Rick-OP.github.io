...
function runDemo(){
  var link = "https://discord.gg/3acB6WxskB"; //CHANGE HERE
 confirmThis("KKPP OFFICIAL", "Due To Security Reasons You're Not Allowed To Do That!","CLOSE", "CONTACT DEV",function(){
    //Continue code here
